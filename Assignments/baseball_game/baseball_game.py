...
def get_not_duplicated_three_digit_number():
    ...
    while is_duplicated_number(str(num)) == True:
        num = get_random_number()
        result = num
    result = num
    # ==================================
...
def main():
    ...
    while user_input != random_number:
        if user_input == "0":
            ...
            k, v = get_strikes_or_ball(user_input, random_number)
            print("Strikes :", k, "Balls :", v)
    ...
    if user_input == random_number:
        ...
        while user_input == random_number:
            ...
            if is_yes(user_ans) == True:
                main_2()
                break
            elif is_no(user_ans) == True:
                break
            else:
                print("Wrong Input, Input again")
